...
I am a **Computer Science student** passionate about building **secure and scalable backend systems**.

My primary focus is **Backend Development using Node.js and NestJS**, where I design **RESTful APIs, microservices architectures, and reliable backend services**.

I also have a strong interest in **Cyber Security and Penetration Testing**, focusing on:
